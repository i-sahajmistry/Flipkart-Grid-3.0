...
arr = [[680,738], [700,450], [740,300], [670,180], [397,78], [218,105], [83,105]]
...
while True:
    ...
    if laut_jao==0:
        ...
        if cy>py+30:
            ...
            h1 = str(min(100, (cx - py // 6)+15))
            h2 = str(min(90, (cx - py // 6)))
            ...
            dictionary = {'func': f'0110145145','l':l} 
        ...
        if cx <  500: 
            ...
            print("rotate")
            dictionary = {'func': f'1001130130','l':l}
            ...
            k = 0
            dictionary = {'func': f'1010070030','l':l}
            print ("straight back")
