...
def cvfunc():
    ...
    while True:
        ...
        #int y=[90,15],[90,30],[120,30],[120,15],[90,45],[120,45]
        #forward = 120-agl*4,120+agl*4
        #turn = y
        #later forward agl=agl+90
            if laut_jao==0:
                if cy>py[l][0]+50:
                    h1=str(max(30,120+agl*4))
                    h2=str(max(30,120-agl*4))
                    h1 = '0'*(3-len(h1)) + h1
                    h2 = '0'*(3-len(h2)) + h2
                ...
                elif atan2(130-cy,60-cx)-5<agl+90 <atan2(130-cy,60-cx)+5:
                    agl=agl+90
                    h1=str(max(0,120+agl*4))
                    h2=str(max(0,120-agl*4))
                    h1 = '0'*(3-len(h1)) + h1
                    h2 = '0'*(3-len(h2)) + h2
                    dictionary = {'func': f'1010{h2}{h1}', 'l': l}
                    print("Forward to final destination yeah")  
                elif cx < px[l][0]:
                    print("stop")
                    ...
                    dictionary = {'func': f'1010030150', 'l': l}
