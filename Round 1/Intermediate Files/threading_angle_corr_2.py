...
dictionary = {"func": "10100000000", "l": 0}
...
def cvfunc():
    ...
    arr = [
        [[580, 140], [75, 125], [580, 140], [550, 747]],
        [[580, 140], [178, 49], [580, 140], [627, 744]],
        [[781, 160], [1345, 10], [781, 160], [747, 763]],
        [[781, 160], [1345, 81], [781, 160], [604, 636]],
    ]
    ...
    while True:
        ...
        if stop == 1:
            ...
            if s == 0:
                ...
                s = 0
                stop = 0
            dictionary = {"func": f"00000000001", "l": l}
            # print(now, then)
        # if stop==1:
        #     time.sleep(5)
        #     Stop = 0
            ...
            if laut_jao == 0:
                if l == 0 or l == 1:
                    if cy > py[l][0] and k == 0:
                        ...
                        h1 = "0" * (3 - len(h1)) + h1
                        h2 = "0" * (3 - len(h2)) + h2
                        dictionary = {"func": f"1010{h2}{h1}0", "l": l}
                        # print(shortestAngle)
                        # print("Forward")

                    elif agl > 20:

                        dictionary = {"func": f"01100900900", "l": l}
                        # print("rotate")

                    elif cx < px[l][0]:
                        # print("stop")
                        dictionary = {"func": "00000000000", "l": l}
                        k = 0
                        laut_jao = 1
                        index = 2
                        stop = 1
                    ...
                    if cy > py[l][0] and k == 0:
                        ...
                        dictionary = {"func": f"10010900900", "l": l}
                        # print("rotate")
                ...
                if l == 0 or l == 1:
                    if cx < px[l][1]:
                        ...
                        h1 = "0" * (3 - len(h1)) + h1
                        h2 = "0" * (3 - len(h2)) + h2
                        dictionary = {"func": f"0101{h2}{h1}0", "l": l}
                        ...
                        # print("stop")
                        dictionary = {"func": f"00000000000", "l": l}
                        l += 1
                        laut_jao = 0
                        index = 0
                        stop = 2
