...
def cvfunc():
    ...
    while True:
        ...
        #     print ("Turn Left")
        # print(degs,int0101070070HeadingDeg,center,shortestAngle)
        ...
        if laut_jao==0:
            ...
            if cy>py-80 and k == 0:
                ...
                # print(h1, h2, (cy - py) // 3)
                dictionary = {'func': f'0101090090','l':l}
                # dictionary = {'func': f'0101{h2}{h1}','l':l}
                print ("Forward")
            elif agl > 20:
                dictionary = {'func': f'0110100100','l':l} 
                print(" rotate")
            elif cx < 150-80:
                print("stop")
            ...
            # -------------------------------
                ...
                dictionary = {'func': f'1010060030','l':l}
                ...
                # 1001125125
                print("rotate")
                dictionary = {'func': f'100120120','l':l}
