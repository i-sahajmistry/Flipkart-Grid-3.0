...
while True:
    ...
    if laut_jao==0: 
        ...
        if cy > py: 
            ...
            h1 = str(min(35, (cy - py // 6)))
            h2 = str(min(65, (cy - py // 6)))
            ...
            print("rotate")
            dictionary = {'func': f'0110130130'} 
        
        elif cx<160:
            print("stop")
            dictionary = {'func': f'0110000000'} 
            laut_jao=1
            k=0
        
        else:
            k = 90
            dictionary = {'func': f'0101070030'}
            print ("left")
